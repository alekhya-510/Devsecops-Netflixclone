...
- Provision an EC2 instance on AWS with the following configuration:
     * **t2.large**
     * storage 25gb
     * Security group - enable SSH,HTTP,HTTPS
- Elastic IP to be associated with the instance


**Step 2: Cloning the Code from github repository:**
...
- Clone your application's code repository onto the EC2 instance:
    ...
    ```bash
    sudo apt-get update
    git clone https://github.com/alekhya-510/Devsecops-Netflixclone.git
    ```
    

**Step 3: Installing Docker and Running the App Using a Container:**
...
- Build and run your application using Docker containers:
  ...
  **TMDB API Key generation:**
   ...
   ```
    We need to open the port 8081 in ec2 security group and can be accessed with https://<public-ip>:8081 as below
...
4. **Access your Application**
   - To Access the app make sure port 30007 is open in your security group and then open a new tab paste your NodeIP:30007, your app should be running.
     ...
     <img width="1728" alt="Screenshot 2025-01-30 at 22 06 11" src="https://github.com/user-attachments/assets/de3c9114-2de1-493b-8d89-8aa6c601c61e" />
